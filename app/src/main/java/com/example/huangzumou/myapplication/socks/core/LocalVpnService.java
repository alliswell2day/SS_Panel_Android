...
import com.example.huangzumou.myapplication.socks.core.ProxyConfig.IPAddress;
import com.example.huangzumou.myapplication.socks.dns.DnsPacket;
import com.example.huangzumou.myapplication.socks.tcpip.CommonMethods;
import com.example.huangzumou.myapplication.socks.tcpip.IPHeader;
import com.example.huangzumou.myapplication.socks.tcpip.TCPHeader;
import com.example.huangzumou.myapplication.socks.tcpip.UDPHeader;
...
public class LocalVpnService extends VpnService implements Runnable {
	...
	private ParcelFileDescriptor establishVPN() throws Exception {
		...
		Intent intent=new Intent(this, InfoActivity.class);//修改过0423
